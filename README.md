...
- npm install --save bulma-stylus@0.8.0 deepmerge@^4.2.2 hexo@^4.2.0 hexo-component-inferno@^0.2.4 hexo-log@^1.0.0 hexo-pagination@^1.0.0 hexo-renderer-inferno@^0.1.3 hexo-renderer-stylus@^1.1.0 hexo-util@^1.8.0 inferno@^7.3.3 inferno-create-element@^7.3.3
